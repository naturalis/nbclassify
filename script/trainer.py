...
class Common(object):
    ...
    def set_config(self, config):
        ...
        if not isinstance(config, common.Struct):
            raise TypeError("Configurations object must be of type common.Struct, not %s" % type(config))
...
class TestAnn(Common):
    ...
    def test(self, ann_file, test_file):
        ...
        self.test_data = common.TrainData()
        try:
